...
test_delta_val = 15
fault_p = 0
filter_table = [read_truth_table("table_T/New_Small_h_x0_v%s.txt"%test_delta_val)]
filter_table.append(read_truth_table("table_T/New_Small_h_x1_v%s.txt"%test_delta_val))
filter_table.append(read_truth_table("table_T/New_Small_h_x2_v%s.txt"%test_delta_val))
filter_table.append(read_truth_table("table_T/New_Small_h_x3_v%s.txt"%test_delta_val))
